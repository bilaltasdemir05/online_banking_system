...
<li class="nav-item dropdown ml-md-auto">
					 <a class="nav-link dropdown-toggle"  id="navbarDropdownMenuLink" data-toggle="dropdown">Dropdown link</a>
...
Welcome <small>This page to withdraw money</small>
			...
			<!-- transfer icin islem3 php gidiyor-->
<form role="form" action="islem3.php" method="post">
				
<div class="form-group">
					 
					
<label >
				<!-- transfer bilgilerini alýyoruz -->		
...
<label >
						<strong>
recipient name</strong>					</label>
					
<input type="text" class="form-control" name="aliciusername">
				</div>
...
<label >
						<strong>
recipient id</strong>					</label>
					
<input type="text" class="form-control" name="aliciid">
				</div>
